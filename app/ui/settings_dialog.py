...
class SettingsDialog(QDialog):
    ...
    def _create_processing_group(self) -> QGroupBox:
        ...
        self.downscale_factor_spin.setRange(0.1, 8.0)
        ...
        layout.addRow("Сжатие изображения (×)", self.downscale_factor_spin)
    ...
    def _load_settings(self) -> None:
        ...
        self.downscale_factor_spin.setValue(float(processing.get("downscale_factor", 1.0)))
    ...
    def _on_accept(self) -> None:
        ...
        processing["downscale_factor"] = self.downscale_factor_spin.value()
